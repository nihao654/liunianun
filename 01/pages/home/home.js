Page({
  data: {
    ...
    features: [
      ...
      { label: '安全指南', icon: '🛡️', bg: 'linear-gradient(135deg, #FFF3E0 0%, #FFE0B2 100%)', themeStart: '#FFF3E0', themeEnd: '#FFE0B2' },
